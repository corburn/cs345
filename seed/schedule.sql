...
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (18, 2, TO_DATE('2015-04-22 18:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-29 22:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (19, 4, TO_DATE('2015-04-22 12:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-29 17:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (20, 4, TO_DATE('2015-04-22 17:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-29 22:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (21, 5, TO_DATE('2015-04-22 14:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-29 22:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (22, 1, TO_DATE('2015-04-22 12:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-30 16:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (23, 1, TO_DATE('2015-04-22 17:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-30 20:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (24, 3, TO_DATE('2015-04-22 12:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-30 17:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (25, 3, TO_DATE('2015-04-22 18:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-30 22:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (26, 4, TO_DATE('2015-04-22 12:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-30 17:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (27, 4, TO_DATE('2015-04-22 17:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-30 22:00', 'yyyy-mm-dd hh24:mi'))
INTO schedule(sche_id, emp_id, sche_start, sche_end) VALUES (28, 6, TO_DATE('2015-04-22 14:00', 'yyyy-mm-dd hh24:mi'), TO_DATE('2015-04-30 22:00', 'yyyy-mm-dd hh24:mi'))
SELECT 1 FROM dual;
